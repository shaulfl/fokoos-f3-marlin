...
#define CUSTOM_MACHINE_NAME "KiNG FOKOOS VXIII"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp   33.10
  #define DEFAULT_bedKi    2.93
  #define DEFAULT_bedKd  250.10
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MANUAL_PROBE_START_Z 0.25  // (mm) Comment out to use the last-measured height
#endif
...
#define TOUCH_SCREEN
  ...
  #define TOUCH_CALIBRATION_X  17108
  #define TOUCH_CALIBRATION_Y -11342
  #define TOUCH_OFFSET_X         -36
  #define TOUCH_OFFSET_Y         336
