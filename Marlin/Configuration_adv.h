...
// LCD Print Progress options
  ...
  #define SD_FINISHED_RELEASECOMMAND "G1X0Y235\nM18XYE"  // Use "M84XYE" to keep Z enabled so your bed stays in place
  ...
  #define EVENT_GCODE_SD_ABORT "G1X0Y235\nM18XYE"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_PURGE_LEN   40 // (mm) Length of filament to purge on resume
    //#define POWER_LOSS_RETRACT_LEN 10 // (mm) Length of filament to retract on fail. Requires backup power.

    // Without a POWER_LOSS_PIN the following option helps reduce wear on the SD card,
    // especially with "vase mode" printing. Set too high and vases cannot be continued.
    #define POWER_LOSS_MIN_Z_CHANGE 0.16 // (mm) Minimum Z change before saving power-loss data
...
#define LIN_ADVANCE
  ...
  #define ADVANCE_K 0.00    // Unit: mm compression per 1mm/s extruder speed
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_UNLOAD_PURGE_LENGTH        14  // (mm) An unretract is done, then this length is purged.
